...
class IntervalGui(Gui):
    ...
    def add_lock_to_key_gui(self):
        ...
        self.g_lock_to_key_hbox = gtk.HBox()
        self.config_box.pack_start(self.g_lock_to_key_hbox, False)
        check = gu.nCheckButton(self.m_exname, 'lock-to-key',
            _("Lock intervals to key:"),
            callback = toggle_lock_to_key_sensitivity)
        self.g_lock_to_key_hbox.pack_start(check, False)
        ...
        self.g_lock_to_key_hbox.pack_start(self.g_notename, False)
        ...
        self.g_lock_to_key_hbox.pack_start(self.g_scaletype, False)
