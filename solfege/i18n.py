...
def setup(prefix, config_locale=None):
    global locale_setup_failed, translation
    ...
    import __builtin__
    translation = gettext.translation("solfege",
                           os.path.join(prefix, 'share', 'locale'),
                           fallback=True)
    __builtin__.__dict__['_'] = translation.ugettext
    __builtin__.__dict__['_no_xgettext'] = translation.ugettext
    __builtin__.__dict__['_i'] = _i
    __builtin__.__dict__['_i_no_xgettext'] = _i
    __builtin__.__dict__['ungettext'] = translation.ungettext
    # plurals usage:
